...
const TranscriberCard: React.FC<TranscriberCardProps> = (props) => {
        ...
        <div className="card bg-base-100 shadow-xl rounded-lg">
            ...
            <div className="card-body p-3 text-black bg-white rounded-bl-lg rounded-br-lg">
                ...
                <div className="mt-2 flex items-center gap-2 rounded-bl-lg rounded-br-lg">
                    ...
                    <Link to={`/ai-transcribers/transcriber/${props.uuid}`} onClick={() => { dispatch(eventUUID(props.uuid)); dispatch(heading("AI Transcriber")) }} className='active:scale-90 duration-300 w-full p-2 rounded-lg bg-purple-500 text-white text-xl grid place-content-center'>
                        <LuBrainCircuit />
                    </Link>
