...
import TranscriberCard from './components/TranscriberCard';
import { TiChevronLeft, TiChevronRight } from 'react-icons/ti'; // Import icons for pagination

const AITranscribers: React.FC = () => {
