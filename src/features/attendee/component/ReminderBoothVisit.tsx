                        ...
                        <div className="mt-10">
                            ...
                            <div className='w-2/3 bg-zinc-200 mt-5 rounded-xl p-5'>
                                <p>
                                    ...
                                    Just a friendly reminder to take this opportunity to network with fellow attendees and explore the booths in the exhibition area. It's a great chance to connect, learn, and discover new insights! <br /> <br />
...
export default ReminderBoothVisit;
